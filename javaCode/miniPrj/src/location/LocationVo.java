...
public class LocationVo {
	...
	public LocationVo(String locationNo, String branchName, String locationAddress, String distance, String telephone,
			String locationEelYn, String locationExpoYn) {
		this.locationNo = locationNo;
		this.branchName = branchName;
		this.locationAddress = locationAddress;
		this.distance = distance;
		this.telephone = telephone;
		this.locationEelYn = locationEelYn;
	...
	public String toString() {
		return "LocationVo [locationNo=" + locationNo + ", branchName=" + branchName + ", locationAddress="
				+ locationAddress + ", distance=" + distance + ", telephone=" + telephone + ", locationEelYn="
				+ locationEelYn + ", locationExpoYn=" + locationExpoYn + "]";
	}
	...
	public String getLocationEelYn() {
		return locationEelYn;
	}
	public void setLocationEelYn(String locationEelYn) {
		this.locationEelYn = locationEelYn;
	}
